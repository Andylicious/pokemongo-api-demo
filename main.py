...
def main():
    ...
    poke_map = folium.Map(location=[FLOAT_LAT,FLOAT_LONG],zoom_start=18,tiles='Stamen Terrain')
    while True:
        ...
        for poke in visible:
            ...
            folium.Marker([poke.Latitude,poke.Longitude], popup=pokemons[poke.pokemon.PokemonId - 1]['Name']).add_to(poke_map)
        print('')
        walk = getNeighbors()
    ...
    poke_map.save('poke_map.html')
    webbrowser.open_new('file://'+os.path.realpath("poke_map.html"))
